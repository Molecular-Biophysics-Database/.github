...
### [mbdb-app](https://github.com/Molecular-Biophysics-Database/mbdb-app)

Where all the information (including the model) needed to install a running
instance of mbdb can be found.

### [mbdb-model](https://github.com/Molecular-Biophysics-Database/mbdb-model)

Where the data models (including vocabularies), and tools for 
working with them, are being developed.

### [mbdb-input-ui](https://github.com/Molecular-Biophysics-Database/mbdb-input-ui) 

Where the deposition form is being developed (deprecated).

### [mbdb-docs](https://github.com/Molecular-Biophysics-Database/mbdb-docs)

Where the user documentation is being developed. 

### [mbdb-search](https://github.com/Molecular-Biophysics-Database/mbdb-search)
